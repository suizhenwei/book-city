...
var chapter = require('./render/chapter-list');
var reader1 = require('./render/data1');
var reader2 = require('./render/data2');
var reader3 = require('./render/data3');
var reader4 = require('./render/data4');
var data = {
    '/api/index': homeData,
